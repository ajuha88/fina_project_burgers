...
for (var i = 0; i < data.data.length; i++) {
  ...
  if (location.Category === "Burger Joint"){
    ...
    L.marker([location.lats, location.lngs]).bindPopup("<h5>Category: " + location.Category + "</h5><hr><h5>Neighborhood: " + location.Neighborhood + "</h5><hr><h5>Venue: " + location.Venue + "</h5><h5>Rating: " + location.Rating + " and " + location.Count + " reviews</h5>"))
  } 
